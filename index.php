...
<nav class="bg-black shadow-md top-0 left-0 w-full z-50">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-2">
            ...
            <!-- Right Links -->
            <div class="hidden md:flex space-x-4 p-2">
                <a href="apparelShop.php" class="font-abhaya-libre uppercase text-white tracking-wider px-4 xl:px-8 py-2 text-lg hover:underline">SHOP</a>
                <a href="order_history.php" class="font-abhaya-libre uppercase text-white tracking-wider px-4 xl:px-8 py-2 text-lg hover:underline">Order History</a>
                <?php if ($isLoggedIn): ?>
