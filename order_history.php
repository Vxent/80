        ...
        <div class="flex justify-between items-center py-2">
            ...
            <div class="flex-1 flex justify-end">
                <div class="hidden md:flex space-x-4 p-2">
                    ...
                    <a href="logout.php"><button type="submit" class="block font-bold bg-yellow-400 text-white py-2 px-6 rounded hover:bg-orange-300 transition">Logout</button></a>
                </div>
            </div>
...
<script>
    ...
    <div class="container mx-auto">
        ...
        <a href="customizedOrderHistory.php" class="text-blue-500">Link to customized orders</a>
